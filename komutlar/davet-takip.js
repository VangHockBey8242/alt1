...
exports.run = async (client, message, args, config) => {
  ...
  let channel = message.mentions.channels.first()
    ...
    if (!channel) {
        return message.reply("** Doğru Kullanım: ** c/davet-takip #kanal")
    }
...
exports.conf = {
    enabled: true,
    guildOnly: false,
    aliases: ['davet-kanal-belirle','davetkanal','davettakip','davet-takip','davettakipayarla','davet-takip-ayarla','dt'],
    permLevel: 0,
}
exports.help = {
    name: 'davet-takip',
